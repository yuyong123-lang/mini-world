...
export const BLOCK = {
  ...
  // ---- 34 省级行政区扩展（37..46，新建筑材质，分配表见 34 区扩展计划 D3）----
  WHITE_STONE: 37, RED_BRICK: 38, BLUE_TILE: 39, GREEN_TILE: 40,
  DARK_TILE: 41, CONCRETE: 42, GLASS_CURTAIN: 43, DARK_WOOD: 44,
  THATCH: 45, PASTEL_WALL: 46,
} as const;

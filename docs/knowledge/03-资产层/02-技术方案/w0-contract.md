---
文档编号: DOC-AST-02-001
标题: W0 契约波（34 省扩展 · 基础设施）
类型: 方案
状态: 现行
日期: 2026-09-01
作者: my-world 项目组
描述: W0 波次任务卡：W0 契约波（34 省扩展 · 基础设施）——Agent 分工、独占文件与波次验收标准
标签: [任务卡, W0, 多Agent]
---
...
契约依据：[buildings.md](../../02-技术层/05-接口文档/buildings.md)（kit 清单/铁律/anchorMargin/接入四步）。
...
| A5 文档 | docs/knowledge/03-资产层/02-技术方案/w0-contract.md ~ w7-final.md、docs/knowledge/02-技术层/05-接口文档/buildings.md、docs/knowledge/01-项目层/03-架构设计/01-项目层/03-架构设计/architecture.md §6、docs/knowledge/02-技术层/03-编码规范/conventions.md §8-§9 | 本套增量文档（波次卡 8 张 + 契约 + 架构增补 + 规则追加） | 与计划文件第四节波次表一致；主线程评审通过 |

...
日期: 2026-08-27
作者: my-world 项目组
描述: T22 第一人称玩家控制器——W2 波次任务卡：目标、独占文件、交付物与验收标准
标签: [任务卡, W2, 多Agent]
---
...
## 契约引用
- 02-技术层/05-接口文档/interfaces.md §12 PlayerController 签名照抄；常量 GRAVITY/JUMP_SPEED/WALK_SPEED/SPRINT_SPEED 从 constants 取
